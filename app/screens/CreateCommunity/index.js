...
import { adminCreateGroupResource } from "hey-resources/Groups";
import { getJoinedGroups, createGroup } from "hey-redux/actions/groups";
...
class CreateCommunity extends React.Component {
  ...
  _createCommunity = (_data, _cb) => {
    _data.cb = r => {
      if (!r || !r.success) {
        console.log("aoutch group not created:", r);
        _cb(true);
      } else {
        console.log("group created:", { _data, r });
        _cb(false, r.result);
      }
    };
    this.props.createGroup(_data);
  };
        ...
        <Header
          ...
          actions={[
            ...
            },
            {
              ...
              onPress: () => {
                this._createCommunity(this.state, (_error, _group) => {
                  if (_error) {
                    // manage Errors
                    Alert.alert(
                      I18n.t("Profile.Oops"),
